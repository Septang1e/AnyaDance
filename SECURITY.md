...
The companion tool does not install global keyboard hooks. It reads key state only while its window has foreground focus and neutralizes inputs on focus loss.